  ...
  return (
    <label className="block">
      ...
      <input
        ...
        type={type}
        required
        autoComplete={autoComplete ?? (name === "email" ? "email" : type === "password" ? "new-password" : undefined)}
  ...
  return (
    <div className="w-full max-w-sm">
      ...
      >
        ...
        <Field name="password" type="password" label="Password" placeholder="min 12 characters" autoComplete={mode === "signin" ? "current-password" : "new-password"} />
        {state?.error && (
