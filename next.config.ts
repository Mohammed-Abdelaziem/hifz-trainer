...
const securityHeaders = [
  ...
  },
  {
    ...
    value: [
      ...
      "connect-src 'self' https://api.quran.com https://verses.quran.com https://audio.everyayah.com https://mp3quran.net https://server8.mp3quran.net https://server13.mp3quran.net https://server7.mp3quran.net https://server11.mp3quran.net https://server10.mp3quran.net https://accounts.google.com https://oauth2.googleapis.com https://github.com https://githubusercontent.com",
